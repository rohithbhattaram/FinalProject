...
var defaultURL = "/static/resources/v1/paymentinfo";
d3.json(defaultURL).then(function(rawdata) {
  var data = [rawdata.results[0],rawdata.results[1],rawdata.results[2]];
  var layout = {title: "Payment Trends for Yesterday", margin: { t: 60, b: 120 },height: 700, width: 1000,xaxis: { title: "Hours of the day" },yaxis: { title: "Customer Activity Frequency" } };
...
var updated_layout = {title: "Payment Trends for Yesterday", margin: { t: 60, b: 120 }, height: 700, width: 1000
